    ...
    public class Neo4jDataAccess : IDataAccess {
        ...
        private List<Source> GetSourcesByLocation(Location location) {
            ...
            try {
                ...
                client.Dispose();
                throw new Exception("Something went wrong when trying to get a source", ne);
            }
        ...
        private  List<State> GetStatesBySource(Source source) {
            ...
            try {
                ...
                client.Dispose();
                throw new Exception("Something went wrong when trying to get a state", ne);
            }
